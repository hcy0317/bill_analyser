...
function createHistoryItem(overrides: Partial<BudgetHistoryItem>): BudgetHistoryItem {
    return {
        ...
        budgetAmountCents: overrides.budgetAmountCents ?? 10000,
        spentAmountCents: overrides.spentAmountCents ?? 5000,
        remainingAmountCents: overrides.remainingAmountCents ?? 5000,

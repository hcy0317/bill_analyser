use bill_analyser_core::{
    account_rules::{AccountRuleCandidate, FIELD_DESCRIPTION, TRANSACTION_SCOPE_ALL},
    ai_ocr_llm::{
        ...
        build_ocr_recognition_success_response,
        ...
        copy_runtime_llm_config, llm_available_providers,
        ...
        render_llm_prompt_template, safe_llm_config_payload, OcrProviderTextLine,
        OcrProviderTextResult, ReceiptDraftAccount, ReceiptDraftCategory, ReceiptDraftCategoryRule,
        ReceiptDraftContext, ReceiptDraftTag,
    },
};
...
fn ocr_recognition_success_response_maps_taxonomy_to_auto_fill_and_candidates() {
    ...
    let context = ReceiptDraftContext {
        ...
        account_rules: vec![AccountRuleCandidate {
            rule_id: 9001,
            account_id: 200,
            account_role_scope: "source".to_string(),

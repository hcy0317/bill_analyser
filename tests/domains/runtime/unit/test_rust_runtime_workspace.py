...
def test_architecture_docs_record_rust_primary_http_and_import_runtime_gates() -> None:
    ...
    assert "Python-proxied provider generation routes remain outside this Rust-owned import-session boundary; global Learning Center suggestion/rule routes are Rust-owned by the P11 learning-center runtime slice" in migration_plan

...
def test_inventory_covers_all_backend_python_files_and_current_rust_count(repo_root: Path) -> None:
    ...
    assert inventory.summary["rust_backend_files"] == 115
    ...
    assert "crates/bill-analyser-db/tests/recurring_runtime.rs" in inventory.rust_files
    ...
    assert "crates/bill-analyser-http/src/backup_sync.rs" in inventory.rust_files
    ...
    assert "crates/bill-analyser-http/src/matching_routes.rs" in inventory.rust_files
    ...
    assert "crates/bill-analyser-http/tests/matching_runtime_contract.rs" in inventory.rust_files
...
def test_every_python_file_has_migration_domain_status_and_no_verified_dead(repo_root: Path) -> None:
    ...
    assert "src/bill_analyser/api/routes/category_rules.py" not in records
    assert "src/bill_analyser/api/routes/encryption.py" not in records
    assert "src/bill_analyser/api/routes/calendar.py" not in records
    assert "src/bill_analyser/api/routes/networth.py" not in records
    assert "src/bill_analyser/api/routes/recurring.py" not in records
    assert "src/bill_analyser/api/routes/rules.py" not in records
    assert "src/bill_analyser/api/routes/tags.py" not in records
    ...
    assert "src/bill_analyser/api/routes/bills/import_config.py" not in records
    ...
    assert "src/bill_analyser/api/routes/budgets/history.py" not in records
    assert "src/bill_analyser/api/routes/budgets/io.py" not in records
    assert "src/bill_analyser/api/routes/budgets/support.py" not in records
    assert "src/bill_analyser/api/routes/statistics/asset_trends.py" not in records
    assert "src/bill_analyser/api/routes/statistics/category_analysis.py" not in records
    assert "src/bill_analyser/api/routes/statistics/exchange_rates.py" not in records
    assert "src/bill_analyser/api/routes/statistics/trend_analysis.py" not in records
    assert "src/bill_analyser/api/routes/statistics/basic.py" not in records
    assert "src/bill_analyser/api/routes/statistics/support.py" not in records
...
def test_inventory_markdown_is_deterministic_and_contains_auditable_counts(repo_root: Path) -> None:
    ...
    assert "src/bill_analyser/api/routes/category_rules.py" not in first_render
    assert "src/bill_analyser/api/routes/tags.py" not in first_render
    assert "src/bill_analyser/api/routes/calendar.py" not in first_render
    assert "src/bill_analyser/api/routes/networth.py" not in first_render
    assert "src/bill_analyser/api/routes/recurring.py" not in first_render
    assert (
    ...
    assert "src/bill_analyser/api/routes/templates.py" not in first_render
    assert "src/bill_analyser/api/routes/settings_bundle.py" not in first_render
    assert "src/bill_analyser/api/routes/statistics/asset_trends.py" not in first_render
    assert "src/bill_analyser/api/routes/statistics/category_analysis.py" not in first_render
    assert "src/bill_analyser/api/routes/statistics/exchange_rates.py" not in first_render
    assert "src/bill_analyser/api/routes/statistics/trend_analysis.py" not in first_render
    assert "src/bill_analyser/api/routes/statistics/basic.py" not in first_render
    assert "src/bill_analyser/api/routes/statistics/support.py" not in first_render
    assert "src/bill_analyser/api/routes/bills/category_actions.py" not in first_render
    assert "src/bill_analyser/api/routes/bills/crud_prepare.py" not in first_render
    assert "src/bill_analyser/api/routes/bills/import_config.py" not in first_render
    ...
    assert "src/bill_analyser/api/routes/budgets/history.py" not in first_render
    assert "src/bill_analyser/api/routes/budgets/io.py" not in first_render
    assert "src/bill_analyser/api/routes/budgets/support.py" not in first_render
    ...
    assert "- crates/bill-analyser-db/src/llm.rs" in first_render
    assert "- crates/bill-analyser-db/src/recurring.rs" in first_render
    ...
    assert "- crates/bill-analyser-db/tests/llm_runtime.rs" in first_render
    assert "- crates/bill-analyser-db/tests/recurring_runtime.rs" in first_render
    ...
    assert "- crates/bill-analyser-http/src/backup_sync.rs" in first_render
    ...
    assert "- crates/bill-analyser-http/src/matching_routes.rs" in first_render
    ...
    assert "- crates/bill-analyser-http/tests/matching_runtime_contract.rs" in first_render

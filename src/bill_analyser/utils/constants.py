...
TRANSACTION_TYPE_NAMES: dict[int, dict[str, str]] = {
    ...
    TransactionType.INVESTMENT: {"zh-CN": "投资", "zh-TW": "投資", "en-US": "Investment"},
}
...
VALID_SORT_FIELDS = ["date", "amount", "type", "category", "account", "created_at", "updated_at"]
...
ERROR_MESSAGES: dict[int, dict[str, str]] = {
    ...
    ErrorCode.NOT_FOUND: {"zh-CN": "资源不存在", "en-US": "Resource not found"},
    ErrorCode.CONFLICT: {"zh-CN": "资源冲突", "en-US": "Resource conflict"},
    ErrorCode.VALIDATION_ERROR: {"zh-CN": "数据验证失败", "en-US": "Validation failed"},
    ErrorCode.INTERNAL_ERROR: {"zh-CN": "服务器内部错误", "en-US": "Internal server error"},
    ErrorCode.DATABASE_ERROR: {"zh-CN": "数据库操作失败", "en-US": "Database operation failed"},
}

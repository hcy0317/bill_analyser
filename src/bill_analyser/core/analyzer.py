...
class Analyzer:
    ...
    @log_method
    @log_step("生成数据分析报告")
    async def generate_report(self, period: str = 'month',
    ...
    @log_method
    async def get_trends(self, period: str = 'month',
    ...
    @log_method
    async def get_comparison(self, period: str = 'month',
                            compare_type: str = 'category') -> Dict[str, Any]:
        """
        获取对比数据
    ...
    @log_method
    async def analyze_category(self, period: str = 'month',
                               main_category: Optional[str] = None) -> Dict[str, Any]:
        """
        分析指定分类

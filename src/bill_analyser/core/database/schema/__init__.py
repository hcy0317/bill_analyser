...
from .core import DatabaseSchemaCoreMixin
from .templates_imports import DatabaseSchemaTemplatesImportsMixin
from .users_security import DatabaseSchemaUsersSecurityMixin
...
class DatabaseSchemaMixin(
    ...
    async def init_db(self) -> None:
        ...
        await self._migrate_bills_hash_unique_constraint(conn)

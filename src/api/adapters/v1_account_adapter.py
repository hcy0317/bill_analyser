    ...
    def build_hierarchy(accounts: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for parent in top_level_accounts:
            ...
            if parent_id in sub_accounts_map:
                ...
                logger.debug(f"父账户 id={parent_id} 有 {len(parent['subAccounts'])} 个子账户")

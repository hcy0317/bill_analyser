...
export default defineConfig(() => {
    ...
    const options: UserConfig = {
        ...
        base: './',
        define: {
            __bill_analyser_IS_PRODUCTION__: process.env['NODE_ENV'] === 'production',
            __bill_analyser_VERSION__: JSON.stringify(packageFile.version),
            __bill_analyser_BUILD_UNIX_TIME__: JSON.stringify(buildUnixTime),
            __bill_analyser_BUILD_COMMIT_HASH__: JSON.stringify(commitHash),
            __bill_analyser_LICENSE__: JSON.stringify(licenseContent),
            __bill_analyser_THIRD_PARTY_LICENSES__: JSON.stringify(thirdPartyLicenseFile)
        },
        plugins: [
            vue({
                template: {
            ...
            VitePWA({
                ...
                manifest: {
                    ...
                    icons: [
                        {
                            src: 'img/bill_analyser-192.png',
                            sizes: '192x192',
                            type: 'image/png'
                        },
                        {
                            src: 'img/bill_analyser-512.png',
                            sizes: '512x512',
                            type: 'image/png'
                        }
                    ]
                    ...
                    configure: (proxy: any, _options: any) => {
                        ...
                        proxy.on('proxyReq', (proxyReq: any, req: any, _res: any) => {
                            ...
                            if (req.headers.authorization) {
                                ...
                                console.log('[Vite Proxy] Authorization header present: NO');
                            }
                        });

...
export const SUPPORTED_IMPORT_FILE_CATEGORY_AND_TYPES: ImportFileCategoryAndTypes[] = [
    {
        categoryName: 'bill analyser File Format',
        fileTypes: [
            {
                type: 'bill analyser',
                name: 'bill analyser Data Export File',
                extensions: '.csv,.tsv',
                subTypes: [
                    {
                        type: 'bill_analyser_csv',
                        name: 'CSV (Comma-separated values) File',
                        extensions: '.csv',
                    },
                    {
                        type: 'bill_analyser_tsv',
    ...
    },
    {
        ...
        fileTypes: [
            {
                type: 'auto',
                name: 'Auto Detect (Automatic Recognition)',
                extensions: '.csv,.xlsx,.xls',
                document: {
                    supportMultiLanguages: true,
                    anchor: 'how-to-import-bank-statement-files'
                }
            },
            {
                type: 'wechat',
            ...
            {
                type: 'alipay',
                name: 'Alipay Statement File',
                extensions: '.csv',
                document: {
                    supportMultiLanguages: 'zh-Hans',
                    anchor: '如何获取支付宝交易流水文件'
                }
            },
            {
                type: 'icbc',
                name: 'ICBC (工商银行) Statement File',
                extensions: '.csv,.xlsx,.xls',
                document: {
                    supportMultiLanguages: 'zh-Hans',
                    anchor: '如何获取工商银行流水文件'

...
import { type TextualYearMonthDay, type Year0BasedMonth, type LocalizedDateRange, type LocalizedRecentMonthDateRange, type WeekDayValue, DateRange, DateRangeScene } from '@/core/datetime.ts';
...
export function useTransactionListPageBase() {
    ...
    function changeDateFilter(dateRange: LocalizedRecentMonthDateRange): void {

<template>
    <f7-page data-testid="mobile.about.page">
        ...
        <f7-list strong inset dividers>
            ...
            <f7-list-item :title="tt('Official Website')" link="#" @click="openExternalUrl('https://github.com/mayswind/bill_analyser')"></f7-list-item>
            <f7-list-item :title="tt('Report Issue')" link="#" @click="openExternalUrl('https://github.com/mayswind/bill_analyser/issues')"></f7-list-item>
            <f7-list-item :title="tt('Getting help')" link="#" @click="openExternalUrl('https://bill_analyser.mayswind.net')"></f7-list-item>
        ...
        <f7-popup push with-subnavbar swipe-to-close swipe-handler=".swipe-handler" class="license-popup">
            <f7-page>
                ...
                <f7-block strong outline class="license-content">
                    ...
                    <hr/>
                    <p>
                        <span>bill_analyser also contains additional third party software and illustration.</span><br/>

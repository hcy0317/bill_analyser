<template>
    <f7-page :ptr="!sortable" data-testid="mobile.accounts.page" @ptr:refresh="reload" @page:afterin="onPageAfterIn">
        <f7-navbar>
            ...
            <f7-nav-right class="navbar-compact-icons">
                ...
                <f7-link data-testid="mobile.accounts.action.add" href="/account/add" icon-f7="plus" v-if="!sortable"></f7-link>

<template>
    <f7-page data-testid="mobile.settings.page">
        ...
        <f7-list strong inset dividers>
            ...
            <f7-list-item :title="tt('Account Recognition Rules')" link="/account/rules"></f7-list-item>
...
import { getThemeFamilyOptionValue } from '@/core/theme.ts';

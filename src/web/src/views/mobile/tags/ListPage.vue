<template>
    <f7-page :ptr="!sortable && !hasEditingTag" data-testid="mobile.tags.page" @ptr:refresh="reload" @page:afterin="onPageAfterIn">
        <f7-navbar>
            ...
            <f7-nav-right class="navbar-compact-icons">
                ...
                <f7-link data-testid="mobile.tags.action.add" :class="{ 'disabled': hasEditingTag }" icon-f7="plus" v-if="!sortable" @click="add"></f7-link>

                ...
                <template #item.categoryId="{ item }">
                    <div class="d-flex align-center">
                        <ItemIcon size="24px" icon-type="category"
                                  :icon-id="item.category?.icon || allCategoriesMap[item.categoryId]?.icon || ''"
                                  :color="item.category?.color || allCategoriesMap[item.categoryId]?.color || ''"
                                  v-if="(item.category && item.category.icon) || (allCategoriesMap[item.categoryId] && allCategoriesMap[item.categoryId]?.icon)"></ItemIcon>
                        ...
                        <span class="ms-2" v-else>
                            {{ item.category?.name || allCategoriesMap[item.categoryId]?.name }}
                        </span>
                    </div>
                </template>

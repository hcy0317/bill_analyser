                        ...
                        <div class="mx-6 mt-4">
                            ...
                            <v-select
                                ...
                                :items="[
                                    ...
                                    { displayName: tt('Investment'), type: 5 }
                                ]"
                                v-model="queryType"
                            />
                        </div>
                                                ...
                                                <td :colspan="showTagInTransactionListPage ? 6 : 5" class="font-weight-bold">
                                                    <div class="d-flex align-center">
                                                        ...
                                                        <v-chip class="ms-1" color="default" size="x-small"
                                                                v-if="transaction.getDisplayDayOfWeekObject()">
                                                            {{ getWeekdayLongName(transaction.getDisplayDayOfWeekObject()!) }}
                                                        </v-chip>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="transaction-table-row-data text-sm cursor-pointer"
                                                ...
                                                <td class="transaction-table-column-account">
                                                    <div class="d-flex align-center">
                                                        ...
                                                        <v-icon class="icon-with-direction mx-1" size="13" :icon="mdiArrowRight" v-if="transaction.sourceAccount && (transaction.type === TransactionType.Transfer || transaction.type === TransactionType.Investment) && transaction.destinationAccount && transaction.sourceAccount.id !== transaction.destinationAccount.id"></v-icon>

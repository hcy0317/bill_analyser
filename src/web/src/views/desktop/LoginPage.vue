            ...
            <v-col cols="12" md="4" class="auth-card d-flex flex-column">
                <div class="d-flex align-center justify-center h-100">
                    <v-card variant="flat" class="w-100 mt-0 px-4 pt-12" max-width="500">
                        <v-card-text>
                            <h4 class="text-h4 mb-2">{{ tt('Welcome to bill analyser') }}</h4>
                            <p class="mb-0" v-if="isInternalAuthEnabled()">{{ tt('Please log in with your bill analyser account') }}</p>
                        ...
                        <v-card-text class="pt-0">
                            <v-row>
                                ...
                                <v-col cols="12" class="text-center text-sm">
                                    ...
                                    <a href="https://github.com/mayswind/bill_analyser" target="_blank">bill analyser</a>&nbsp;<span>{{ version }}</span>
                                </v-col>
                            </v-row>
                        </v-card-text>
                    </v-card>

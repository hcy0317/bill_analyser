<template>
    <v-row class="match-height" data-testid="desktop.about.page">
        <v-col cols="12">
            <v-card>
                <template #title>
                ...
                <v-card-text>
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col cols="12" md="10" class="mb-6">
                            <a class="text-body-1" href="https://github.com/mayswind/bill_analyser" target="_blank">
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col cols="12" md="10" class="mb-6">
                            <a class="text-body-1" href="https://github.com/mayswind/bill_analyser/issues" target="_blank">
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col cols="12" md="10">
                            <a class="text-body-1" href="https://bill_analyser.mayswind.net" target="_blank">

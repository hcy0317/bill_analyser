...
const clientVersionHolder: VersionInfo = {
    version: __bill_analyser_VERSION__,
    commitHash: __bill_analyser_BUILD_COMMIT_HASH__,
    buildTime: __bill_analyser_BUILD_UNIX_TIME__
};
...
export function isProduction(): boolean {
    return __bill_analyser_IS_PRODUCTION__;
}

...
export const useOverviewStore = defineStore('overview', () => {
    ...
    function initTransactionDateRange(dateRange: TransactionDataRange): void {
        ...
        dateRange.thisYear.startTime = getThisYearFirstUnixTime(userStore.currentUserFiscalYearStart);
        dateRange.thisYear.endTime = getThisYearLastUnixTime(userStore.currentUserFiscalYearStart);
    ...
    watch(() => userStore.currentUserFiscalYearStart, () => {

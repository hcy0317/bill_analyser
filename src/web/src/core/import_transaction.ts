...
export class ImportTransactionDataMapping {
    private static readonly JSON_ROOT_FIELD = 'bill_analyserImportTransactionDataMapping';
...
export class ImportTransactionReplaceRules {
    private static readonly JSON_ROOT_FIELD = 'bill_analyserImportTransactionReplaceRules';

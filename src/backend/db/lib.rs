...
pub use postgres_account_recovery::{
    ...
    resolve_postgres_account_recovery_target, sync_postgres_account_recovery_auth,
    AccountRecoveryApplyOptions, AccountRecoveryApplyReport, AccountRecoveryAuthSyncOptions,
    AccountRecoveryAuthSyncReport, AccountRecoveryDryRunReport, AccountRecoveryExpectedCounts,

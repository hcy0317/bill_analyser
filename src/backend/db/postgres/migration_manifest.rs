...
const POSTGRES_MIGRATION_MANIFEST: &[PostgresMigrationDescriptor] = &[
    ...
    PostgresMigrationDescriptor {
        version: 30,
        file_name: "0030_bills_foreign_key_indexes.sql",
        description: "index import preview bill references for bounded delete enforcement",
        required_tables: &["import_preview_rows"],
        required_indexes: &["idx_import_preview_rows_history_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 31,
        file_name: "0031_import_decision_members_history_bill_index.sql",
        description: "index import decision member bill references",
        required_tables: &["import_decision_group_members"],
        required_indexes: &["idx_import_decision_group_members_history_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 32,
        file_name: "0032_import_history_materializations_bill_index.sql",
        description: "index import history materialization bill references",
        required_tables: &["import_history_materializations"],
        required_indexes: &["idx_import_history_materializations_history_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 33,
        file_name: "0033_import_confirm_history_bill_index.sql",
        description: "index import confirmation history bill references",
        required_tables: &["import_confirm_operations"],
        required_indexes: &["idx_import_confirm_operations_history_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 34,
        file_name: "0034_import_confirm_created_bill_index.sql",
        description: "index import confirmation created bill references",
        required_tables: &["import_confirm_operations"],
        required_indexes: &["idx_import_confirm_operations_created_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 35,
        file_name: "0035_import_confirm_deleted_bill_index.sql",
        description: "index import confirmation deleted bill references",
        required_tables: &["import_confirm_operations"],
        required_indexes: &["idx_import_confirm_operations_deleted_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 36,
        file_name: "0036_matching_pairs_left_bill_index.sql",
        description: "index matching pair left bill references",
        required_tables: &["matching_pairs"],
        required_indexes: &["idx_matching_pairs_left_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 37,
        file_name: "0037_matching_pairs_right_bill_index.sql",
        description: "index matching pair right bill references",
        required_tables: &["matching_pairs"],
        required_indexes: &["idx_matching_pairs_right_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 38,
        file_name: "0038_matching_suppressions_left_bill_index.sql",
        description: "index matching suppression left bill references",
        required_tables: &["matching_suppressions"],
        required_indexes: &["idx_matching_suppressions_left_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 39,
        file_name: "0039_matching_suppressions_right_bill_index.sql",
        description: "index matching suppression right bill references",
        required_tables: &["matching_suppressions"],
        required_indexes: &["idx_matching_suppressions_right_bill_id"],
    },
    PostgresMigrationDescriptor {
        version: 40,
        file_name: "0040_import_learning_samples_bill_index.sql",
        description: "index import learning sample bill references",

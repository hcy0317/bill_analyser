...
const DEFAULT_DAILY_CATEGORY_RULES: &[DefaultCategoryRule] = &[
    ...
    DefaultCategoryRule { name: "default:交通出行/公交地铁", main_category: "交通出行", sub_category: "公交地铁", rule_expression: "OR={地铁,公交,公交地铁,公共交通,轨道交通,交通卡,一卡通,乘车码}", priority: 410 },
    ...
    DefaultCategoryRule { name: "default:金融保险/投资支出", main_category: "金融保险", sub_category: "投资支出", rule_expression: "OR={理财通购买,理财购买,购买理财,基金申购,基金定投,定投扣款,基金买入,证券买入,投资支出}", priority: 1220 },
    DefaultCategoryRule { name: "default:投资收益/理财收益", main_category: "投资收益", sub_category: "理财收益", rule_expression: "OR={理财收益,收益发放,余额宝收益,零钱通收益,基金分红,利息,股息}", priority: 2200 },

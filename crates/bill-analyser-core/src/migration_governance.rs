...
const OWNERSHIP_MATRIX: &[EndpointOwnership] = &[
    ...
    EndpointOwnership {
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessResult,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy accounts runtime recalculates authenticated user account balances from bill source/destination account links and returns the Flask-compatible discrepancy report.",
    },
    ...
    EndpointOwnership {
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessData,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy category-rules runtime lists authenticated user canonical category rules with optional category_id and enabled_only filters.",
    },
    EndpointOwnership {
        method: "POST",
        pattern: "/api/category-rules/",
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessData,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy category-rules runtime creates canonical user-scoped rules and returns the created rule payload.",
    },
    EndpointOwnership {
        method: "DELETE",
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessData,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy category-rules runtime deletes canonical user-scoped rules and preserves Rule not found responses.",
    },
    EndpointOwnership {
        method: "PUT",
        pattern: "/api/category-rules/{rule_id}",
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessData,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy category-rules runtime updates canonical user-scoped rules and returns the refreshed rule payload.",
    },
    EndpointOwnership {
        method: "POST",
    ...
    EndpointOwnership {
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessData,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy category-rules runtime reorders canonical user-scoped rules by request order.",
    },
    EndpointOwnership {
        method: "GET",
        ...
        envelope: ResponseEnvelopeFamily::FlaskSuccessData,
        deletion_blocked_until_all_import_gates: false,
        notes: "Rust taxonomy rule-center runtime aggregates user-scoped import learning rules, enabled category rule count, and recurring rule summaries without mutating rule state.",
    },
...
fn route_contract_details(
    ...
    match (route.domain, route.state) {
        ...
        blocked_status: MigrationBlockedStatus::None,
        unsupported_behavior:
                "Account CRUD/display-order/balance sync/transaction move-clear, tag CRUD/display-order/batch-create, category master-data/statistics/update-all, category-rule list/create/update/delete/reorder/defaults/migrate/test, rule overview, templates, and settings bundle import/preview/export routes are Rust-owned; legacy /api/categories/rules config/cache remains Python-owned until the rest of P4 is ported.",
            decision_required: DecisionRequired::Port,
            decision_owner: "migration-program",
            transition_evidence: DB_RUNTIME_EVIDENCE,
        },

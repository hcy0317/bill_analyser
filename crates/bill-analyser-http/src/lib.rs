...
pub use taxonomy_routes::{
    ...
    TAXONOMY_CATEGORY_ROUTE_PATTERNS, TAXONOMY_CATEGORY_RULE_PROXIED_ROUTE_PATTERNS,
    TAXONOMY_CATEGORY_RULE_ROUTE_PATTERNS, TAXONOMY_RULE_CENTER_PROXIED_ROUTE_PATTERNS,
    TAXONOMY_RULE_CENTER_ROUTE_PATTERNS, TAXONOMY_SETTINGS_BUNDLE_PROXIED_ROUTE_PATTERNS,
    TAXONOMY_SETTINGS_BUNDLE_ROUTE_PATTERNS, TAXONOMY_TAG_PROXIED_ROUTE_PATTERNS,
    TAXONOMY_TAG_ROUTE_PATTERNS, TAXONOMY_TEMPLATE_PROXIED_ROUTE_PATTERNS,

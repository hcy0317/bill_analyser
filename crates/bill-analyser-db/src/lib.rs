...
pub use auth::{
    ...
    get_user_external_auth, hash_two_factor_recovery_code, increment_failed_login,
    ...
    replace_two_factor_recovery_codes, rotate_refresh_token_session, set_user_email_verified,

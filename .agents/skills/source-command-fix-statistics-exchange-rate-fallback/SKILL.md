---
name: "source-command-fix-statistics-exchange-rate-fallback"
...
# source-command-fix-statistics-exchange-rate-fallback

Use this skill when the user asks to run the migrated source command `fix-statistics-exchange-rate-fallback`.

---
name: "source-command-fix-bill-import-preview"
description: "排查并修复 Bill Analyser 导入预览页问题。适用于预览表格字段为空、金额或类型显示错误、编辑交互异常、重新分类不刷新、选择性导入失效、取消未清理会话。"
---

# source-command-fix-bill-import-preview

Use this skill when the user asks to run the migrated source command `fix-bill-import-preview`.

...
- **`docs/PROJECT_OVERVIEW.md` is a current-state map**: when updating this file, describe stable business behavior, domain relationships, and runtime contracts only; do not append session logs, dated update notes, or bug-fix history
